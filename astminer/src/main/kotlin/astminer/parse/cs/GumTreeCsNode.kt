...
class GumTreeCsNode(val wrappedNode: ITree, val context: TreeContext, val parent: GumTreeCsNode?) : Node {
    ...
    private val childrenList: MutableList<GumTreeCsNode> by lazy {
        wrappedNode.children.map { GumTreeCsNode(it, context, this) }.toMutableList()
    }
